...
# 首页底部推荐
http-response ^https?:\/\/.*map\.baidu\.com\/.*govui\/rich_content script-path=https://raw.githubusercontent.com/aookapp/ipk/main/BaiduMap.plugin, requires-body=true, tag=百度地图_推荐
# DNS处理
http-response ^https?:\/\/httpdns\.baidubce\.com script-path=https://raw.githubusercontent.com/aookapp/ipk/main/BaiduMap.plugin, requires-body=true, tag=百度地图_DNS
# 个人中心
http-response ^https?:\/\/newclient\.map\.baidu\.com\/usercenter\/mine\/page script-path=https://raw.githubusercontent.com/aookapp/ipk/main/BaiduMap.plugin, requires-body=true, tag=百度地图_个人页
# 周边热词
http-response ^https?:\/\/newclient\.map\.baidu\.com\/living\/nearby\/hot-words\? script-path=https://raw.githubusercontent.com/aookapp/ipk/main/BaiduMap.plugin, requires-body=true, tag=百度地图_热词
